...
public class TelaSolicitacoes extends JFrame {
	...
	/**
	 * Painel com cantos arredondados, usado no card verde grande
	 * e no item de solicitação (pill).
	 */
	...
	public TelaSolicitacoes() {
		...
		JButton btnHome = new JButton(""); // ícone de casa (fallback em texto)
		btnHome.setIcon(new ImageIcon(TelaSolicitacoes.class.getResource("/imagens/casa 1.png")));
		...
		JLabel lblLocalizacao = new JLabel(" Gaspar - SC");
		lblLocalizacao.setIcon(new ImageIcon(TelaSolicitacoes.class.getResource("/imagens/loc.png")));
		...
		lblSolicitacoes.setForeground(new Color(10, 86, 27));
		...
		Image imagemRedimensionada = logo.getImage().getScaledInstance(
				180, 90, Image.SCALE_SMOOTH
		);
		...
		// =====================================================
		// PAINEL DE SOLICITAÇÕES (agora com cantos arredondados)
		// =====================================================
		...
		// =====================================================
		// SOLICITAÇÃO (pill arredondada, mais respiro interno)
		// =====================================================
		...
		informacoes.setLayout(new MigLayout(
				"insets 0",
				"[grow]",
				"[]2[]"
		));
		...
		btnRecusar.setForeground(new Color(150, 30, 30));
